...
<div class="container mt-4">
    <h2>Data Guru</h2>
    <a class="btn btn-primary" href="kelolaguru.php" role="button">Tambah Data</a>
    <br><br>
    <table class="table table-striped">
        ...
        <tbody>
            ...
            while($guru = mysqli_fetch_array($query)) {
                ...
                echo "<td>
                <a href='kelolaguru.php?edit=".$guru['id_guru']."' class='btn btn-warning'>Edit</a>
                  <a href='prosesguru.php?hapus=".$guru['id_guru']."' class='btn btn-danger'>Delete</a>
                </td>";
                echo "</tr>";
        }
?>
